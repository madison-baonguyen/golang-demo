...
func (server *Server) CreatePost(w http.ResponseWriter, r *http.Request) {
	...
	postCreated, err := services.SavePost(server.DB, &post)
	if err != nil {
...
func (server *Server) GetPosts(w http.ResponseWriter, r *http.Request) {
	...
	posts, err := services.FindAllPosts(server.DB, &post)
	if err != nil {
...
func (server *Server) GetPost(w http.ResponseWriter, r *http.Request) {
	...
	postReceived, err := services.FindPostByID(server.DB, &post, pid)
	if err != nil {
		responses.ERROR(w, http.StatusInternalServerError, err)
		return
	}
...
func (server *Server) UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	postUpdated, err := services.UpdateAPost(server.DB, &postUpdate)
...
func (server *Server) DeletePost(w http.ResponseWriter, r *http.Request) {
	...
	_, err = services.DeleteAPost(server.DB, &post, pid, uid)
	if err != nil {
		responses.ERROR(w, http.StatusBadRequest, err)
		return
	}
